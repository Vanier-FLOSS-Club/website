...
<template>
  <div class="hello s-card" @mouseleave="resetHello">
    ...
    <div class="info">
      ...
      <div class="link">
        <a href="https://github.com/Vanier-FLOSS-Club" target="_blank" class="social-link">
          <i class="font-awesome fa-brands fa-github"></i>
        </a>
        <a href="https://www.linkedin.com/company/vanier-floss-club/" target="_blank" class="social-link">
